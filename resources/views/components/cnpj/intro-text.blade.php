<div class="bg-white p-6 sm:p-8 rounded-xl shadow-lg border border-gray-100">
    ...
    <h1 class="text-3xl lg:text-4xl font-bold text-gray-900">{{ $data['razao_social'] }}</h1>
    ...
    {{-- Parágrafo dinâmico otimizado para SEO --}}
    <div class="mt-6 pt-5 border-t border-gray-200 space-y-4 text-gray-700 leading-relaxed">
        <p>
            ...
            Sua principal atividade econômica, de acordo com o CNAE (Classificação Nacional de Atividades Econômicas), é <strong>{{ $data['cnae_principal']['descricao'] }}</strong>.
        </p>
        <p>
