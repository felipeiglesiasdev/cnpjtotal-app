...
<section class="bg-[#171717] py-24 md:py-32 overflow-hidden">
    <div class="container mx-auto max-w-6xl px-6 sm:px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-4xl mx-auto">
            ...
            {{-- Card 2: Consultar Empresas por CEP --}}
            <a href="{{ route('cep.index') }}" class="group relative block rounded-xl border border-white/10 bg-white/5 p-8 shadow-lg backdrop-blur-lg transition-all duration-300 hover:bg-white/10 hover:-translate-y-1.5 overflow-hidden">
                 <div class="flex items-center">
                    {{-- Ícone --}}
                     <div class="mr-6 flex h-16 w-16 flex-shrink-0 items-center justify-center rounded-full bg-[#ed1c24]/10 border border-[#ed1c24]/30 transition-all duration-300 group-hover:bg-[#ed1c24]">
                    ...
                    {{-- Textos --}}
                    <div>
                        <h3 class="text-2xl font-semibold text-white mb-1 group-hover:text-red-100 transition-colors duration-300">Empresas por CEP</h3>
                        <p class="text-gray-300 font-light">Descubra quais empresas estão ativas em um CEP específico.</p>
                    </div>
                </div>
                 {{-- Seta no Hover --}}
                 <div class="absolute top-1/2 right-6 -translate-y-1/2 transform text-white opacity-0 transition-all duration-300 group-hover:opacity-100 group-hover:right-8">
