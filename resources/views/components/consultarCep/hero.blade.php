<section class="relative bg-white pt-32 pb-20 md:pt-40 md:pb-28 overflow-hidden">
    ...
    <div class="relative container mx-auto px-4 z-10">
        <div class="max-w-3xl mx-auto text-center">
            <span class="text-sm font-semibold text-[#ed1c24] uppercase tracking-wider mb-3 inline-block">Consulte empresas ativas pelo CEP</span>
            <h1 class="text-4xl lg:text-6xl font-bold text-gray-900 mb-5 tracking-tight leading-tight">
                Consulte CNPJs por CEP 
            </h1>
            ...
            <form id="cep-form" class="max-w-3xl mx-auto"  action="{{ route('portal.por-cep', ['cep' => 'CEP_PLACEHOLDER']) }}" method="GET" novalidate>
                @csrf
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (cepInput && cepForm) {
            ...
            cepForm.addEventListener('submit', function(e) {
                e.preventDefault(); 
                const cepValue = cepMask.unmaskedValue; 
                let baseUrl = cepForm.action.replace('CEP_PLACEHOLDER', cepValue);
